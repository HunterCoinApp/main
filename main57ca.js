...
const sttaddr = "0x402Ce3b97c02A5622274EF35812c72CF9ba10D4C";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
function getreflink() {
    document.getElementById('refaddresscopy').value = 'https://huntercoin.net/?ref=' + document.getElementById('refaddress').value;
}
